...
<head>
  <title>%(title)s</title>
  <meta http-equiv="content-type" content="text/html; charset=%(encoding)s">
  <link rel="stylesheet" href="%(cssfile)s" type="text/ccs">
</head>
<body>
<h2>%(title)s</h2>
...
class HtmlFormatter(Formatter):
    ...
    `noclobber_cssfile`
        If `cssfile` is given and the specified file exists, the ccs file will
        not be overwritten. This allows the use of the `full` option in
        combination with a user specified ccs file. Default is ``False``.
    ...
    **Subclassing the HTML formatter**
    ...
    def _get_css_class(self, ttype):
        """Return the ccs class of this token type prefixed with
